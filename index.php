...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Zafari - Parc Zoologique & Safari</title>
  ...
  <body>
      ...
      <div class="row gx-0 d-none d-lg-flex">
        <div class="col-lg-7 px-5 text-start">
          <div class="h-100 d-inline-flex align-items-center py-3 me-4">
            ...
            <small>123 Street, Tunis, Tunisia</small>
          </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-4 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse py-4 py-lg-0" id="navbarCollapse">
            <div class="navbar-nav ms-auto">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                        ...
                        <a href="visiting.html" class="dropdown-item">Horaires de Visite</a>
            ...
            <a href="book_tickets.php" class="btn btn-primary">Acheter un Billet<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
        ...
        <div class="col-lg-6 p-0 wow fadeIn" data-wow-delay="0.1s">
          ...
          >
            <h1 class="display-4 text-light mb-5">
              Profitez d'une Merveilleuse Journée en Famille
            </h1>
            <div class="d-flex align-items-center pt-4 animated slideInDown">
              ...
              <h6 class="text-white m-0 ms-4 d-none d-sm-block">Voir la Vidéo</h6>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row g-5">
          <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
            <p><span class="text-primary me-2">#</span>Welcome To Zafari</p>
            <h1 class="display-5 mb-4">
              Why You Should Visit
              <span class="text-primary">Zafari</span> Park!
            </h1>
            <p class="mb-4">
      ...
      <div class="container py-5">
        <div class="row g-4">
          ...
          >
            ...
            <p class="text-white mb-0">Nombre d'Animaux</p>
          </div>
          <div
            class="col-md-6 col-lg-3 text-center wow fadeIn"
            data-wow-delay="0.3s"
          ...
          >
            ...
            <h1 class="text-white mb-2" data-toggle="counter-up">12345</h1>
            <p class="text-white mb-0">Total des Adhésions</p>
          </div>
          <div
            class="col-md-6 col-lg-3 text-center wow fadeIn"
            data-wow-delay="0.7s"
        ...
        <div class="row g-5 mb-5 wow fadeInUp" data-wow-delay="0.1s">
          <div class="col-lg-6">
            ...
            <h1 class="display-5 mb-0">
              ...
              <span class="text-primary">Zafari</span> Visitors
            </h1>
          </div>
          <div class="col-lg-6">
            <div
            ...
            >
              ...
              <div class="ms-4">
                ...
                <h2 class="text-white mb-0">+216 98 765 432</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        >
          <div class="col-lg-6">
            ...
            <h1 class="display-5 mb-0">
              Let`s See Our <span class="text-primary">Zafari</span> Awesome
              Animals
            </h1>
          </div>
          ...
          <div class="col-md-6 text-light wow fadeIn" data-wow-delay="0.5s">
            ...
            <table class="table">
              <tbody>
                <tr>
                  <td>Office</td>
                  <td>123 Street, Tunis, Tunisia</td>
                </tr>
                <tr>
                  <td>Zoo</td>
                  <td>123 Street, Tunis, Tunisia</td>
        ...
        >
          <div class="col-lg-6">
            ...
            <h1 class="display-5 mb-0">
              ...
              <span class="text-primary">Zafari</span>
            </h1>
          </div>
          <div class="col-lg-6 text-lg-end">
        ...
        <div class="row g-4">
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="membership-item position-relative">
              ...
              <h3 class="text-primary mb-4">99.000</h3>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="membership-item position-relative">
              ...
              <h3 class="text-primary mb-4">149.000</h3>
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
            <div class="membership-item position-relative">
              ...
              <h3 class="text-primary mb-4">199.000</h3>
      ...
      <div class="container py-5">
        <div class="row g-5">
          <div class="col-lg-3 col-md-6">
            ...
            <p class="mb-2">
              <i class="fa fa-map-marker-alt me-3"></i>123 Street, Tunis, Tunisia
            </p>
            <p class="mb-2">
              <i class="fa fa-phone-alt me-3"></i>+216 98 765 432
            </p>
            <p class="mb-2">
